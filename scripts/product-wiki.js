(function () {
  ...
  const labels = {
    en: {
      ...
      contactLead: "Use the public GitHub organization for product documentation, firmware repositories, and issue-based technical discussion.",
    ...
    zh: {
      ...
      contactTitle: "联系",
      contactLead: "通过公开 GitHub 组织查看产品文档、固件仓库，并进行基于 Issue 的技术讨论。",
