...
const PUBLIC_REFERENCE_FILES = {
  ...
  "h7wlite-v2": [
    ...
    download("assets/downloads/firmware/h7wlite-v2/betaflight_2026.6.2_STM32H743_FLYINGRCH7WLITEV2_BMI270.hex", "Betaflight 2026.6.2 BMI270 firmware", "Betaflight 2026.6.2 BMI270 固件"),
  ...
  "f4wing-mini-mk1": [
    ...
    download("assets/downloads/firmware/f4wing-mini-mk1/betaflight_2026.6.2_STM32F405_FLYINGRCF4WINGMINI.hex", "Betaflight 2026.6.2 firmware", "Betaflight 2026.6.2 固件"),
  ...
  "f4wse-pro": [
    ...
    download("assets/downloads/firmware/f4wse-pro/betaflight_2026.6.2_STM32F405_FLYINGRCF4WSEPRO.hex", "Betaflight 2026.6.2 firmware", "Betaflight 2026.6.2 固件"),
  ...
  "h7d-pro": [
    ...
    download("assets/downloads/firmware/h7d-pro/betaflight_2026.6.2_STM32H743_FLRCH7DPRO_DUAL-ICM.hex", "Betaflight 2026.6.2 DUAL-ICM firmware", "Betaflight 2026.6.2 DUAL-ICM 固件"),
...
const FIRMWARE_DOWNLOAD_METADATA = {
  ...
  "assets/downloads/firmware/h7wlite-v2/betaflight_2026.6.2_STM32H743_FLYINGRCH7WLITEV2_BMI270.hex": firmwareMeta({
    family: "betaflight", version: "2026.6.2", channel: "stable", role: "latest-stable", target: "STM32H743 / FLYINGRCH7WLITEV2_BMI270",
    boardRevisionEn: "H7Wlite V2 dual BMI270 / SPA06-003 / QMC5883P revision; ICM42688P and ICM42605 alternatives are retained.",
    boardRevisionZh: "H7Wlite V2 双 BMI270 / SPA06-003 / QMC5883P 版本；保留 ICM42688P 与 ICM42605 替代器件支持。",
    checksum: "aaf7b9ec096a97e4b4fb30bc48725fc91c02f420cce06e45126d2fe7cc51b0a0",
    compatibilityEn: "Betaflight 2026.6.2 firmware for FLYINGRCH7WLITEV2_BMI270, built with dual BMI270 and alternative ICM42688P / ICM42605 sensor support.",
    compatibilityZh: "适用于 FLYINGRCH7WLITEV2_BMI270 的 Betaflight 2026.6.2 固件，支持双 BMI270，并保留 ICM42688P / ICM42605 替代器件。"
  }),
  "assets/downloads/firmware/h7wlite-v2/betaflight_2026.6.1_STM32H743_FLYINGRCH7WLITEV2_BMI270.hex": firmwareMeta({
    family: "betaflight", version: "2026.6.1", channel: "stable", role: "archive",
    archiveNoteEn: "Archived formal release; use Betaflight 2026.6.2 as the recommended stable release.",
    archiveNoteZh: "历史正式版本；推荐使用 Betaflight 2026.6.2 稳定版。",
  ...
  "assets/downloads/firmware/h7wlite-v2/betaflight_4.5.5_STM32H743_FLYINGRCH7WLITEV2_BMI270.hex": firmwareMeta({
    ...
    archiveNoteEn: "Retained stable 4.5.x build; use Betaflight 2026.6.2 for the current recommended stable build.",
    archiveNoteZh: "保留的 4.5.x 稳定构建；当前推荐稳定版请使用 Betaflight 2026.6.2。",
    target: "STM32H743 / FLYINGRCH7WLITEV2_BMI270",
    boardRevisionEn: "H7Wlite V2 BMI270 / SPA06-003 / QMC5883P revision; BMI270 hardware only.",
    boardRevisionZh: "H7Wlite V2 BMI270 / SPA06-003 / QMC5883P 版本；仅适用于 BMI270 硬件。",
  ...
  "assets/downloads/firmware/f4wing-mini-mk1/betaflight_2026.6.2_STM32F405_FLYINGRCF4WINGMINI.hex": firmwareMeta({
    family: "betaflight", version: "2026.6.2", channel: "stable", role: "latest-stable", target: "STM32F405 / FLYINGRCF4WINGMINI",
    boardRevisionEn: "F4Wing Mini MK1; verify IMU and barometer revision before flashing.",
    boardRevisionZh: "F4Wing Mini MK1；刷写前请核对 IMU 和气压计版本。",
    checksum: "4369288287f3be7884bf38d4819a65403fcc8dc0f86bf174963f98ee00873225",
    compatibilityEn: "Betaflight 2026.6.2 firmware for the FLYINGRCF4WINGMINI target.",
    compatibilityZh: "适用于 FLYINGRCF4WINGMINI 目标的 Betaflight 2026.6.2 固件。"
  }),
  ...
  "assets/downloads/firmware/f4wing-mini-mk1/betaflight_4.5.5_STM32F405_FLYINGRCF4WINGMINI.hex": firmwareMeta({
    ...
    channel: "stable",
    role: "archive",
    archiveNoteEn: "Retained Betaflight 4.5.5 stable maintenance-line build for users who need the 4.5.x series; use Betaflight 2026.6.2 for the current recommended stable build.",
    archiveNoteZh: "保留的 Betaflight 4.5.5 稳定维护线构建，供需要 4.5.x 系列的用户使用；当前推荐稳定版请优先使用 Betaflight 2026.6.2。",
    target: "STM32F405 / FLYINGRCF4WINGMINI",
    boardRevisionEn: "F4Wing Mini MK1; verify IMU and barometer revision before flashing.",
    boardRevisionZh: "F4Wing Mini MK1；刷写前请核对 IMU 和气压计版本。",
  ...
  "assets/downloads/firmware/f4wse-pro/betaflight_2026.6.2_STM32F405_FLYINGRCF4WSEPRO.hex": firmwareMeta({
    family: "betaflight", version: "2026.6.2", channel: "stable", role: "latest-stable", target: "STM32F405 / FLYINGRCF4WSEPRO",
    boardRevisionEn: "F4WSE Pro; verify BMI270 or ICM42688P hardware revision before flashing.",
    boardRevisionZh: "F4WSE Pro；刷写前请核对 BMI270 或 ICM42688P 硬件版本。",
    checksum: "665a509a13be573423937b97cca4379cba8dcad40d9a8fe1e41253783e8f2f6a",
    compatibilityEn: "Betaflight 2026.6.2 firmware for the FLYINGRCF4WSEPRO target.",
    compatibilityZh: "适用于 FLYINGRCF4WSEPRO 目标的 Betaflight 2026.6.2 固件。"
  }),
  ...
  "assets/downloads/firmware/h7d-pro/betaflight_2026.6.2_STM32H743_FLRCH7DPRO_DUAL-ICM.hex": firmwareMeta({
    family: "betaflight", version: "2026.6.2", channel: "stable", role: "latest-stable", variantEn: "DUAL-ICM", variantZh: "DUAL-ICM", target: "STM32H743 / FLRCH7DPRO_DUAL-ICM",
    boardRevisionEn: "H7D Pro dual ICM42688 hardware; verify sensor revision before flashing.",
    boardRevisionZh: "H7D Pro 双 ICM42688 硬件；刷写前请核对传感器版本。",
    checksum: "4f05efa52b5bc98bb502369732d664b00b4d54e28b1cc6c180204dcee236af1c",
    compatibilityEn: "Betaflight 2026.6.2 DUAL-ICM firmware for the FLRCH7DPRO target.",
    compatibilityZh: "适用于 FLRCH7DPRO 的 Betaflight 2026.6.2 DUAL-ICM 固件。"
  }),
  "assets/downloads/firmware/h7d-pro/betaflight_2026.6.1_STM32H743_FLRCH7DPRO_DUAL-ICM.hex": firmwareMeta({
    family: "betaflight", version: "2026.6.1", channel: "stable", role: "archive", variantEn: "DUAL-ICM", variantZh: "DUAL-ICM",
    archiveNoteEn: "Archived formal release; use Betaflight 2026.6.2 as the recommended stable release.",
    archiveNoteZh: "历史正式版本；推荐使用 Betaflight 2026.6.2 稳定版。",
    target: "STM32H743 / FLRCH7DPRO_DUAL-ICM",
    boardRevisionEn: "H7D Pro dual ICM42688 hardware; verify sensor revision before flashing.",
